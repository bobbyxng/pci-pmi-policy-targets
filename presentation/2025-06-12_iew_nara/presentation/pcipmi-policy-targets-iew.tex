  ...
  \begin{columns}
    ...
    \begin{column}{0.52\textwidth}
      ...
      \begin{itemize}
        ...
        \item In 2040 and 2050, all sequestration targets are overachieved, potential of 398 Mt p.a. is exploited in all scenarios with PCI-PMI projects.
  ...
  \begin{columns}
    ...
    \begin{column}{0.52\textwidth}
      ...
      \begin{itemize}
        ...
        \item \ce{H2} from Steam Methane Reforming (71 to 102 TWh p.a.) without pipelines.
      \end{itemize}
    \end{column}
  \end{columns}
  \source{Own illustration.}
