  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      ...
      \begin{itemize}
        ...
        \item Spatially and temporally highly linear optimisation model that covers the \alert{European} continent,
    ...
    \begin{column}{.38\textwidth}
        \begin{minipage}[t][.45\textheight]{\linewidth}
            \begin{alertblock}{\textbf{Map of projects}}
              \centering
              \includegraphics[width=0.9\textwidth]{pci_pmi_map}
            \end{alertblock}
        \end{minipage}
    \end{column}
  ...
  \begin{columns}
    \begin{column}{0.55\textwidth}
      ...
      \begin{itemize}
        ...
        \item Implementing \alert{PCI-PMI} hydrogen and carbon infrastructure projects as well as key \alert{policy targets}:
        \vspace{0.1cm}
        \begin{itemize}
          \scriptsize
  ...
  \begin{columns}
    \begin{column}{0.53\textwidth}
      ...
      \begin{itemize}
        ...
        \item Total H$_2$ storage capacity sums up to \alert{977 GWh$_{H_2}$ p.a.}
      \end{itemize}
    \end{column}
...
\begin{frame}{Case study: First results -- System costs}
