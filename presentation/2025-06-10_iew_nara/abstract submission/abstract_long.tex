...
Figure \ref{fig:balance_maps} shows the regional distribution of the \ce{H2} and \ce{CO2} value chain in the Base scenario. Describe regional distribution, UTILISATION OF PIPELINES;FLH, DIRECTOINS, PRICE, LARGE rice delta, specific sink northern lights project norway, denmark, 
